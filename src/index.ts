    ...
    messages: [
      {
        ...
        content: {
          ...
          text: [
            ...
            "## Format",
            "",
            "- `reason_ko`: Korean reasoning — SEPARATE JSON field (required)",
            "- `reason_en`: English reasoning — SEPARATE JSON field (required)",
            "- Both must convey the same analysis, not be literal translations",
            "- Keep each under 200 characters — concise but specific",
            "",
            "**WARNING**: Do NOT combine both languages into the `reason` field like:",
            '  `"reason": "KR: 한국어... EN: English..."`',
            "This is WRONG. Always use `reason_ko` and `reason_en` as separate JSON keys.",
            "",
